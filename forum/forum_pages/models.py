...
class MainTextBanner(models.Model):
    ...
    image = models.ImageField('Фото', upload_to='user_banners')
...
class Theme(models.Model):
    title = models.CharField('Назва теми', max_length=100, null=True)
...
class SubTheme(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE, null=True)
    base_theme = models.ForeignKey(Theme, on_delete=models.CASCADE, null=True, related_name='subthemes')
...
class SubThemeMessage(BaseMessage):
    subtheme = models.ForeignKey(
        SubTheme, on_delete=models.CASCADE, null=True, related_name='subtheme_messages')
...
class AgencyJobOrganization(models.Model):
    title = models.CharField('Назва агенства', max_length=100)
